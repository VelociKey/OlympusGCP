...
const file_google_cloud_tasks_v2_queue_proto_rawDesc = "" +
	...
	"\x05state\x18\x05 \x01(\x0e2\".google.cloud.tasks.v2.Queue.StateR\x05state\x129\n" +
	"\n" +
	"purge_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tpurgeTime\x12m\n" +
	"\x1astackdriver_logging_config\x18\t \x01(\v2/.google.cloud.tasks.v2.StackdriverLoggingConfigR\x18stackdriverLoggingConfig\"E\n" +
	"\x05State\x12\x15\n" +
	...
	"\x1fcloudtasks.googleapis.com/Queue\x126projects/{project}/locations/{location}/queues/{queue}\"\xa9\x01\n" +
	"\n" +
	"RateLimits\x129\n" +
	...
	"\x0esampling_ratio\x18\x01 \x01(\x01R\rsamplingRatioBy\n" +
	"\x19com.google.cloud.tasks.v2B\n" +
	"QueueProtoP\x01ZNolympus.fleet/00SDLC/OlympusGCP/gen/cloudtasks/apiv2/cloudtaskspb;cloudtaskspbb\x06proto3"

var (
	file_google_cloud_tasks_v2_queue_proto_rawDescOnce sync.Once
	file_google_cloud_tasks_v2_queue_proto_rawDescData []byte
)

func file_google_cloud_tasks_v2_queue_proto_rawDescGZIP() []byte {
	file_google_cloud_tasks_v2_queue_proto_rawDescOnce.Do(func() {
		file_google_cloud_tasks_v2_queue_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_tasks_v2_queue_proto_rawDesc), len(file_google_cloud_tasks_v2_queue_proto_rawDesc)))
	})
...
var file_google_cloud_tasks_v2_queue_proto_goTypes = []any{
...
func file_google_cloud_tasks_v2_queue_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_tasks_v2_queue_proto_rawDesc), len(file_google_cloud_tasks_v2_queue_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
