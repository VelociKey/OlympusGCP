...
const file_google_cloud_extended_operations_proto_rawDesc = "" +
	"\n" +
	...
	"\x0foperation_field\x12\x1d.google.protobuf.FieldOptions\x18\xfd\b \x01(\x0e2&.google.cloud.OperationResponseMappingR\x0eoperationField:V\n" +
	"\x17operation_request_field\x12\x1d.google.protobuf.FieldOptions\x18\xfe\b \x01(\tR\x15operationRequestField:X\n" +
	"\x18operation_response_field\x12\x1d.google.protobuf.FieldOptions\x18\xff\b \x01(\tR\x16operationResponseField:L\n" +
	"\x11operation_service\x12\x1e.google.protobuf.MethodOptions\x18\xe1\t \x01(\tR\x10operationService:Y\n" +
	"\x18operation_polling_method\x12\x1e.google.protobuf.MethodOptions\x18\xe2\t \x01(\bR\x16operationPollingMethodBy\n" +
...
var (
	...
	file_google_cloud_extended_operations_proto_rawDescData []byte
)
...
func file_google_cloud_extended_operations_proto_rawDescGZIP() []byte {
	file_google_cloud_extended_operations_proto_rawDescOnce.Do(func() {
		file_google_cloud_extended_operations_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_cloud_extended_operations_proto_rawDesc), len(file_google_cloud_extended_operations_proto_rawDesc)))
	})
...
var file_google_cloud_extended_operations_proto_goTypes = []any{
...
func file_google_cloud_extended_operations_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_cloud_extended_operations_proto_rawDesc), len(file_google_cloud_extended_operations_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 5,
			NumServices:   0,
