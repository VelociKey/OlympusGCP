...
type Bucket struct {
	...
	// error.
	//
	// Deprecated: Marked as deprecated in google/storage/v1/storage_resources.proto.
...
const file_google_storage_v1_storage_resources_proto_rawDesc = "" +
	"\n" +
	")google/storage/v1/storage_resources.proto\x12\x11google.storage.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xcb\x1c\n" +
	"\x06Bucket\x128\n" +
	"\x03acl\x18\x01 \x03(\v2&.google.storage.v1.BucketAccessControlR\x03acl\x12T\n" +
	"\x12default_object_acl\x18\x02 \x03(\v2&.google.storage.v1.ObjectAccessControlR\x10defaultObjectAcl\x12A\n" +
	"\tlifecycle\x18\x03 \x01(\v2#.google.storage.v1.Bucket.LifecycleR\tlifecycle\x12=\n" +
	"\ftime_created\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vtimeCreated\x12\x0e\n" +
	"\x02id\x18\x05 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x06 \x01(\tR\x04name\x12%\n" +
	"\x0eproject_number\x18\a \x01(\x03R\rprojectNumber\x12&\n" +
	"\x0emetageneration\x18\b \x01(\x03R\x0emetageneration\x122\n" +
	"\x04cors\x18\t \x03(\v2\x1e.google.storage.v1.Bucket.CorsR\x04cors\x12\x1a\n" +
	"\blocation\x18\n" +
	" \x01(\tR\blocation\x12#\n" +
	"\rstorage_class\x18\v \x01(\tR\fstorageClass\x12\x12\n" +
	"\x04etag\x18\f \x01(\tR\x04etag\x124\n" +
	"\aupdated\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\aupdated\x127\n" +
	"\x18default_event_based_hold\x18\x0e \x01(\bR\x15defaultEventBasedHold\x12=\n" +
	"\x06labels\x18\x0f \x03(\v2%.google.storage.v1.Bucket.LabelsEntryR\x06labels\x12;\n" +
	"\awebsite\x18\x10 \x01(\v2!.google.storage.v1.Bucket.WebsiteR\awebsite\x12D\n" +
	"\n" +
	"versioning\x18\x11 \x01(\v2$.google.storage.v1.Bucket.VersioningR\n" +
	"versioning\x12;\n" +
	"\alogging\x18\x12 \x01(\v2!.google.storage.v1.Bucket.LoggingR\alogging\x12.\n" +
	"\x05owner\x18\x13 \x01(\v2\x18.google.storage.v1.OwnerR\x05owner\x12D\n" +
	"\n" +
	"encryption\x18\x14 \x01(\v2$.google.storage.v1.Bucket.EncryptionR\n" +
	"encryption\x12;\n" +
	"\abilling\x18\x15 \x01(\v2!.google.storage.v1.Bucket.BillingR\abilling\x12T\n" +
	"\x10retention_policy\x18\x16 \x01(\v2).google.storage.v1.Bucket.RetentionPolicyR\x0fretentionPolicy\x12#\n" +
	"\rlocation_type\x18\x17 \x01(\tR\flocationType\x12W\n" +
	"\x11iam_configuration\x18\x18 \x01(\v2*.google.storage.v1.Bucket.IamConfigurationR\x10iamConfiguration\x12'\n" +
	"\rzone_affinity\x18\x19 \x03(\tB\x02\x18\x01R\fzoneAffinity\x12#\n" +
	"\rsatisfies_pzs\x18\x1a \x01(\bR\fsatisfiesPzs\x12A\n" +
	"\tautoclass\x18\x1c \x01(\v2#.google.storage.v1.Bucket.AutoclassR\tautoclass\x1a0\n" +
	"\aBilling\x12%\n" +
	"\x0erequester_pays\x18\x01 \x01(\bR\rrequesterPays\x1a\x87\x01\n" +
	"\x04Cors\x12\x16\n" +
	...
	"\n" +
	"Encryption\x12/\n" +
	"\x14default_kms_key_name\x18\x01 \x01(\tR\x11defaultKmsKeyName\x1a\xe8\x03\n" +
	"\x10IamConfiguration\x12\x82\x01\n" +
	"\x1buniform_bucket_level_access\x18\x01 \x01(\v2C.google.storage.v1.Bucket.IamConfiguration.UniformBucketLevelAccessR\x18uniformBucketLevelAccess\x12{\n" +
	"\x18public_access_prevention\x18\x02 \x01(\x0e2A.google.storage.v1.Bucket.IamConfiguration.PublicAccessPreventionR\x16publicAccessPrevention\x1aq\n" +
	"\x18UniformBucketLevelAccess\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12;\n" +
	"\vlocked_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"lockedTime\"_\n" +
	"\x16PublicAccessPrevention\x12(\n" +
	"$PUBLIC_ACCESS_PREVENTION_UNSPECIFIED\x10\x00\x12\f\n" +
	"\bENFORCED\x10\x01\x12\r\n" +
	"\tINHERITED\x10\x02\x1a\xaf\a\n" +
	"\tLifecycle\x12<\n" +
	"\x04rule\x18\x01 \x03(\v2(.google.storage.v1.Bucket.Lifecycle.RuleR\x04rule\x1a\xe3\x06\n" +
	"\x04Rule\x12G\n" +
	"\x06action\x18\x01 \x01(\v2/.google.storage.v1.Bucket.Lifecycle.Rule.ActionR\x06action\x12P\n" +
	"\tcondition\x18\x02 \x01(\v22.google.storage.v1.Bucket.Lifecycle.Rule.ConditionR\tcondition\x1aA\n" +
	"\x06Action\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12#\n" +
	"\rstorage_class\x18\x02 \x01(\tR\fstorageClass\x1a\xfc\x04\n" +
	"\tCondition\x12\x10\n" +
	"\x03age\x18\x01 \x01(\x05R\x03age\x12A\n" +
	"\x0ecreated_before\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\rcreatedBefore\x123\n" +
	"\ais_live\x18\x03 \x01(\v2\x1a.google.protobuf.BoolValueR\x06isLive\x12,\n" +
	"\x12num_newer_versions\x18\x04 \x01(\x05R\x10numNewerVersions\x122\n" +
	"\x15matches_storage_class\x18\x05 \x03(\tR\x13matchesStorageClass\x12'\n" +
	"\x0fmatches_pattern\x18\x06 \x01(\tR\x0ematchesPattern\x123\n" +
	"\x16days_since_custom_time\x18\a \x01(\x05R\x13daysSinceCustomTime\x12H\n" +
	"\x12custom_time_before\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x10customTimeBefore\x12;\n" +
	"\x1adays_since_noncurrent_time\x18\t \x01(\x05R\x17daysSinceNoncurrentTime\x12P\n" +
	"\x16noncurrent_time_before\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\x14noncurrentTimeBefore\x12%\n" +
	"\x0ematches_prefix\x18\v \x03(\tR\rmatchesPrefix\x12%\n" +
	"\x0ematches_suffix\x18\f \x03(\tR\rmatchesSuffix\x1aT\n" +
	"\aLogging\x12\x1d\n" +
	"\n" +
	...
	"\x0eeffective_time\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampR\reffectiveTime\x12\x1b\n" +
	"\tis_locked\x18\x02 \x01(\bR\bisLocked\x12)\n" +
	"\x10retention_period\x18\x03 \x01(\x03R\x0fretentionPeriod\x1a&\n" +
	"\n" +
	"Versioning\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x1aY\n" +
	"\aWebsite\x12(\n" +
	"\x10main_page_suffix\x18\x01 \x01(\tR\x0emainPageSuffix\x12$\n" +
	"\x0enot_found_page\x18\x02 \x01(\tR\fnotFoundPage\x1ab\n" +
	"\tAutoclass\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12;\n" +
	"\vtoggle_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"toggleTime\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x8b\x02\n" +
	"\x13BucketAccessControl\x12\x12\n" +
	...
	"\x06domain\x18\t \x01(\tR\x06domain\x12A\n" +
	"\fproject_team\x18\n" +
	" \x01(\v2\x1e.google.storage.v1.ProjectTeamR\vprojectTeam\"`\n" +
	" ListBucketAccessControlsResponse\x12<\n" +
	"\x05items\x18\x01 \x03(\v2&.google.storage.v1.BucketAccessControlR\x05items\"n\n" +
	"\x13ListBucketsResponse\x12/\n" +
	"\x05items\x18\x01 \x03(\v2\x19.google.storage.v1.BucketR\x05items\x12&\n" +
	"\x0fnext_page_token\x18\x02 \x01(\tR\rnextPageToken\"\xf2\x02\n" +
	"\aChannel\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1f\n" +
	"\vresource_id\x18\x02 \x01(\tR\n" +
	"resourceId\x12!\n" +
	"\fresource_uri\x18\x03 \x01(\tR\vresourceUri\x12\x14\n" +
	...
	"\x06params\x18\b \x03(\v2&.google.storage.v1.Channel.ParamsEntryR\x06params\x12\x18\n" +
	"\apayload\x18\t \x01(\bR\apayload\x1a9\n" +
	"\vParamsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\xac\x02\n" +
	"\x14ListChannelsResponse\x12C\n" +
	"\x05items\x18\x01 \x03(\v2-.google.storage.v1.ListChannelsResponse.ItemsR\x05items\x1a\xce\x01\n" +
	"\x05Items\x12\x1d\n" +
	"\n" +
	"channel_id\x18\x01 \x01(\tR\tchannelId\x12\x1f\n" +
	"\vresource_id\x18\x02 \x01(\tR\n" +
	"resourceId\x12\x19\n" +
	"\bpush_url\x18\x03 \x01(\tR\apushUrl\x12)\n" +
	"\x10subscriber_email\x18\x04 \x01(\tR\x0fsubscriberEmail\x12?\n" +
	"\rcreation_time\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\"a\n" +
	"\x0fChecksummedData\x12\x18\n" +
	"\acontent\x18\x01 \x01(\fR\acontent\x124\n" +
	"\x06crc32c\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x06crc32c\"b\n" +
	"\x0fObjectChecksums\x124\n" +
	"\x06crc32c\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x06crc32c\x12\x19\n" +
	"\bmd5_hash\x18\x02 \x01(\tR\amd5Hash\"\xa7\x04\n" +
	"\vCommonEnums\">\n" +
	"\n" +
	"Projection\x12\x1a\n" +
	"\x16PROJECTION_UNSPECIFIED\x10\x00\x12\n" +
	"\n" +
	"\x06NO_ACL\x10\x01\x12\b\n" +
	...
	"\x0fcomplete_length\x18\x03 \x01(\x03R\x0ecompleteLength\"\xb0\x02\n" +
	"\x0fHmacKeyMetadata\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\taccess_id\x18\x02 \x01(\tR\baccessId\x12\x1d\n" +
	"\n" +
	"project_id\x18\x03 \x01(\tR\tprojectId\x122\n" +
	"\x15service_account_email\x18\x04 \x01(\tR\x13serviceAccountEmail\x12\x14\n" +
	"\x05state\x18\x05 \x01(\tR\x05state\x12=\n" +
	"\ftime_created\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\vtimeCreated\x124\n" +
	"\aupdated\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\aupdated\x12\x12\n" +
	"\x04etag\x18\b \x01(\tR\x04etag\"\xe7\x02\n" +
	"\fNotification\x12\x14\n" +
	"\x05topic\x18\x01 \x01(\tR\x05topic\x12\x1f\n" +
	"\vevent_types\x18\x02 \x03(\tR\n" +
	"eventTypes\x12b\n" +
	"\x11custom_attributes\x18\x03 \x03(\v25.google.storage.v1.Notification.CustomAttributesEntryR\x10customAttributes\x12\x12\n" +
	...
	"\x02id\x18\a \x01(\tR\x02id\x1aC\n" +
	"\x15CustomAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"R\n" +
	"\x19ListNotificationsResponse\x125\n" +
	"\x05items\x18\x01 \x03(\v2\x1f.google.storage.v1.NotificationR\x05items\"\x86\f\n" +
	"\x06Object\x12)\n" +
	"\x10content_encoding\x18\x01 \x01(\tR\x0fcontentEncoding\x12/\n" +
	"\x13content_disposition\x18\x02 \x01(\tR\x12contentDisposition\x12#\n" +
	"\rcache_control\x18\x03 \x01(\tR\fcacheControl\x128\n" +
	"\x03acl\x18\x04 \x03(\v2&.google.storage.v1.ObjectAccessControlR\x03acl\x12)\n" +
	...
	"\ftime_created\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\vtimeCreated\x124\n" +
	"\x06crc32c\x18\v \x01(\v2\x1c.google.protobuf.UInt32ValueR\x06crc32c\x12'\n" +
	...
	"\x19retention_expiration_time\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampR\x17retentionExpirationTime\x12C\n" +
	"\bmetadata\x18\x15 \x03(\v2'.google.storage.v1.Object.MetadataEntryR\bmetadata\x12D\n" +
	"\x10event_based_hold\x18\x1d \x01(\v2\x1a.google.protobuf.BoolValueR\x0eeventBasedHold\x12\x12\n" +
	...
	"generation\x12.\n" +
	"\x05owner\x18\x1b \x01(\v2\x18.google.storage.v1.OwnerR\x05owner\x12]\n" +
	"\x13customer_encryption\x18\x1c \x01(\v2,.google.storage.v1.Object.CustomerEncryptionR\x12customerEncryption\x12;\n" +
	"\vcustom_time\x18\x1e \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"customTime\x1af\n" +
	...
	"generation\x12\x16\n" +
	"\x06entity\x18\a \x01(\tR\x06entity\x12\x1b\n" +
	"\tentity_id\x18\b \x01(\tR\bentityId\x12\x14\n" +
	"\x05email\x18\t \x01(\tR\x05email\x12\x16\n" +
	"\x06domain\x18\n" +
	" \x01(\tR\x06domain\x12A\n" +
	"\fproject_team\x18\v \x01(\v2\x1e.google.storage.v1.ProjectTeamR\vprojectTeam\"`\n" +
	" ListObjectAccessControlsResponse\x12<\n" +
	"\x05items\x18\x01 \x03(\v2&.google.storage.v1.ObjectAccessControlR\x05items\"\x8a\x01\n" +
	"\x13ListObjectsResponse\x12\x1a\n" +
	"\bprefixes\x18\x01 \x03(\tR\bprefixes\x12/\n" +
	"\x05items\x18\x02 \x03(\v2\x19.google.storage.v1.ObjectR\x05items\x12&\n" +
	...
	"\tentity_id\x18\x02 \x01(\tR\bentityIdBo\n" +
...
var (
	...
	file_google_storage_v1_storage_resources_proto_rawDescData []byte
)
...
func file_google_storage_v1_storage_resources_proto_rawDescGZIP() []byte {
	file_google_storage_v1_storage_resources_proto_rawDescOnce.Do(func() {
		file_google_storage_v1_storage_resources_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_storage_v1_storage_resources_proto_rawDesc), len(file_google_storage_v1_storage_resources_proto_rawDesc)))
	})
...
var file_google_storage_v1_storage_resources_proto_goTypes = []any{
...
func file_google_storage_v1_storage_resources_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_storage_v1_storage_resources_proto_rawDesc), len(file_google_storage_v1_storage_resources_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   40,
			NumExtensions: 0,
			NumServices:   0,
