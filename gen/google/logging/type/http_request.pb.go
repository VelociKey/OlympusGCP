...
const file_google_logging_type_http_request_proto_rawDesc = "" +
	"\n" +
	...
	"\bprotocol\x18\x0f \x01(\tR\bprotocolB\xbe\x01\n" +
...
var (
	...
	file_google_logging_type_http_request_proto_rawDescData []byte
)
...
func file_google_logging_type_http_request_proto_rawDescGZIP() []byte {
	file_google_logging_type_http_request_proto_rawDescOnce.Do(func() {
		file_google_logging_type_http_request_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_logging_type_http_request_proto_rawDesc), len(file_google_logging_type_http_request_proto_rawDesc)))
	})
...
var file_google_logging_type_http_request_proto_goTypes = []any{
...
func file_google_logging_type_http_request_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_logging_type_http_request_proto_rawDesc), len(file_google_logging_type_http_request_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
