...
const file_google_iam_v1_iam_policy_proto_rawDesc = "" +
	...
	"\x12TestIamPermissions\x12(.google.iam.v1.TestIamPermissionsRequest\x1a).google.iam.v1.TestIamPermissionsResponse\"/\x82\xd3\xe4\x93\x02):\x01*\"$/v1/{resource=**}:testIamPermissions\x1a\x1e\xcaA\x1biam-meta-api.googleapis.comB\x8c\x01\n" +
	"\x11com.google.iam.v1B\x0eIamPolicyProtoP\x01Z9olympus.fleet/00SDLC/OlympusGCP/gen/iam/apiv1/iampb;iampb\xaa\x02\x13Google.Cloud.Iam.V1\xca\x02\x13Google\\Cloud\\Iam\\V1b\x06proto3"
