...
const file_google_iam_v1_policy_proto_rawDesc = "" +
	...
	"\x03ADD\x10\x01\x12\n" +
	"\n" +
	"\x06REMOVE\x10\x02B\x8c\x01\n" +
	"\x11com.google.iam.v1B\vPolicyProtoP\x01Z9olympus.fleet/00SDLC/OlympusGCP/gen/iam/apiv1/iampb;iampb\xf8\x01\x01\xaa\x02\x13Google.Cloud.Iam.V1\xca\x02\x13Google\\Cloud\\Iam\\V1b\x06proto3"
